...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/ubahstatus/{status}/{id}', [DataPesanan::class, 'status_pesanan'])->middleware('userAkses:penjual');
    ...
    Route::get('/transaksi/tambah', [UserController::class, 'tambah_transaksi'])->middleware('userAkses:user');

    Route::get('/riwayat-pesanan', [UserController::class, 'riwayat_pesanan'])->middleware('userAkses:user');
    Route::get('/ubahpesanan/{status}/{id}', [UserController::class, 'status_user'])->middleware('userAkses:user');
