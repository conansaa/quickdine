                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/ubahpesanan/Selesai/{{ $datas->id }}">Selesai</a></li>
                            </ul>
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/ubahpesanan/Pesanan Siap/{{ $datas->id }}">Pesanan Siap</a></li>
                            </ul>
                            @else
